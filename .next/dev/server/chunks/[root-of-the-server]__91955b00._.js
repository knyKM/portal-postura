...
async function POST(request) {
    ...
    const existingUser = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2f$user$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["findUserByEmail"])(email);
    if (!existingUser) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
    ...
    const user = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2f$user$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["validateUserCredentials"])(email, password);
    if (!user) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: "E-mail ou senha incorretos."
        }, {
    ...
    if (!user.mfa_secret || !user.mfa_enabled) {
        const setupToken = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2f$tokens$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createMfaToken"])({
            sub: user.id,
            email: user.email,
            purpose: "setup"
        });
    ...
    const mfaToken = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2f$tokens$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createMfaToken"])({
        sub: user.id,
        email: user.email,
        purpose: "verify"
    });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__91955b00._.js.map