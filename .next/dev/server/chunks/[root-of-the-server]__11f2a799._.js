...
async function GET(request) {
    ...
    const limit = Number.isNaN(limitParam) ? 20 : Math.max(1, Math.min(50, limitParam));
    const notifications = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$notifications$2f$notification$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["listUserNotifications"])(session.id, limit).map(serializeNotification);
    const unreadCount = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$notifications$2f$notification$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["countUnreadNotifications"])(session.id);
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        notifications,
        unreadCount
    });
...
async function PATCH(request) {
    ...
    if (Array.isArray(body?.ids) && body.ids.length > 0) {
        ids = body.ids.map((id)=>Number(id)).filter((id)=>Number.isInteger(id) && id > 0);
        if (ids.length === 0) {
            ids = undefined;
        }
    }
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$notifications$2f$notification$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["markNotificationsAsRead"])(session.id, ids);
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        success: true,
        unreadCount: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$notifications$2f$notification$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["countUnreadNotifications"])(session.id)
    });
}
async function DELETE(request) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$notifications$2f$notification$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["deleteUserNotifications"])(session.id);
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        success: true,
        notifications: [],
        unreadCount: 0
...
//# sourceMappingURL=%5Broot-of-the-server%5D__11f2a799._.js.map