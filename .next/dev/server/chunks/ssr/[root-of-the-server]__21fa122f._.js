...
"[project]/lib/auth/tokens.ts [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function createAuthToken(payload) {
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$jsonwebtoken$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"].sign(payload, AUTH_SECRET, {
        expiresIn: DEFAULT_EXPIRATION
    });
}
function verifyAuthToken(token) {
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$jsonwebtoken$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"].verify(token, AUTH_SECRET);
}
...
function verifyMfaToken(token, expectedPurpose) {
    const payload = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$jsonwebtoken$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"].verify(token, AUTH_SECRET);
...
"[project]/lib/auth/database.ts [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/lib/auth/user-service.ts [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2f$database$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/auth/database.ts [app-rsc] (ecmascript)");
...
function seedAdmin() {
    if (isSeeded) return;
    const stmt = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2f$database$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["db"].prepare("SELECT id, role, is_active FROM users WHERE email = ?");
    const existing = stmt.get(seedUser.email);
    if (!existing) {
        const insert = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2f$database$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["db"].prepare("INSERT INTO users (email, password_hash, name, avatar, role, is_active) VALUES (?, ?, ?, ?, ?, 1)");
        insert.run(seedUser.email, (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2f$password$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["hashPassword"])(seedUser.password), seedUser.name, seedUser.avatar, seedUser.role);
    } else if (existing.role !== seedUser.role || existing.is_active !== 1) {
        const update = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2f$database$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["db"].prepare("UPDATE users SET role = ?, is_active = 1 WHERE id = ?");
...
function findUserByEmail(email) {
    seedAdmin();
    const stmt = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2f$database$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["db"].prepare("SELECT id, email, name, avatar, password_hash, role, is_active, mfa_secret, mfa_enabled, last_seen_at, created_at FROM users WHERE email = ?");
    return stmt.get(email);
}
function validateUserCredentials(email, password) {
    const user = findUserByEmail(email);
    if (!user) return null;
    const isValid = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2f$password$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["verifyPassword"])(password, user.password_hash);
    if (!isValid) {
        return null;
    }
    if (!user.is_active) {
...
function createUser({ name, email, password, role, avatar = null }) {
    ...
    const insert = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2f$database$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["db"].prepare("INSERT INTO users (name, email, password_hash, role, avatar, is_active) VALUES (?, ?, ?, ?, ?, 1)");
    const result = insert.run(name.trim(), normalizedEmail, (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2f$password$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["hashPassword"])(password), role, avatar);
    const insertedId = Number(result.lastInsertRowid);
    const fetchNew = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2f$database$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["db"].prepare("SELECT id, email, name, avatar, password_hash, role, is_active, mfa_secret, mfa_enabled, last_seen_at, created_at FROM users WHERE id = ?");
...
function listAdmins() {
    seedAdmin();
    const stmt = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2f$database$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["db"].prepare("SELECT id, name, email FROM users WHERE role = 'admin'");
    return stmt.all();
}
function listUsers() {
    seedAdmin();
    const stmt = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2f$database$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["db"].prepare("SELECT id, name, email, role, created_at, is_active, last_seen_at FROM users ORDER BY created_at DESC");
    return stmt.all();
}
function updateUserActiveStatus(userId, isActive) {
    seedAdmin();
    const update = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2f$database$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["db"].prepare("UPDATE users SET is_active = ? WHERE id = ?");
    const result = update.run(isActive ? 1 : 0, userId);
    if (result.changes === 0) {
        return null;
    }
    const fetch = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2f$database$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["db"].prepare("SELECT id, email, name, avatar, password_hash, role, is_active, mfa_secret, mfa_enabled, last_seen_at, created_at FROM users WHERE id = ?");
    return fetch.get(userId) ?? null;
}
function findUserById(id) {
    seedAdmin();
    const stmt = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2f$database$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["db"].prepare("SELECT id, email, name, avatar, password_hash, role, is_active, mfa_secret, mfa_enabled, last_seen_at, created_at FROM users WHERE id = ?");
    return stmt.get(id);
}
function upsertUserMfaSecret(userId, secret) {
    const stmt = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2f$database$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["db"].prepare("UPDATE users SET mfa_secret = ?, mfa_enabled = 0 WHERE id = ?");
    stmt.run(secret, userId);
}
function enableUserMfa(userId) {
    const stmt = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2f$database$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["db"].prepare("UPDATE users SET mfa_enabled = 1 WHERE id = ?");
    stmt.run(userId);
}
function updateUserLastSeen(userId) {
    seedAdmin();
    const stmt = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2f$database$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["db"].prepare("UPDATE users SET last_seen_at = CURRENT_TIMESTAMP WHERE id = ?");
    stmt.run(userId);
}
function listOnlineAdmins(withinMinutes = 5) {
    seedAdmin();
    const stmt = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2f$database$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["db"].prepare("SELECT id, name, email, last_seen_at FROM users WHERE role = 'admin' AND last_seen_at IS NOT NULL AND datetime(last_seen_at) >= datetime('now', ?) ORDER BY datetime(last_seen_at) DESC");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2f$tokens$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/auth/tokens.ts [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2f$user$2d$service$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/auth/user-service.ts [app-rsc] (ecmascript)");
;
;
;
;
async function getSessionUser(cookieHeader) {
    ...
    try {
        const payload = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2f$tokens$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["verifyAuthToken"])(token);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2f$user$2d$service$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["updateUserLastSeen"])(payload.sub);
        return {
            id: payload.sub,
            email: payload.email,
            name: payload.name,
...
async function AuthenticatedLayout({ children }) {
    const session = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2f$session$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getSessionUser"])();
    if (!session) {
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$components$2f$navigation$2e$react$2d$server$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["redirect"])("/login?status=expired");
    }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__21fa122f._.js.map